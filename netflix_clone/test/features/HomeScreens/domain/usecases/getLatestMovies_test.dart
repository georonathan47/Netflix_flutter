...
import 'package:netflix_clone/features/Homescreens/domain/usecases/getLatestNetflixMovies.dart';

class MockNetflixRepository extends Mock implements NetflixRepository {}

void main() {
  GetLatestNetflixMovie? usecase;
  MockNetflixRepository? mockNetflixRepository;

  setUp(() {
    mockNetflixRepository = MockNetflixRepository();
    usecase = GetLatestNetflixMovie(mockNetflixRepository!);
  });
